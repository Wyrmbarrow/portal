...
export const TOOLS: Record<ToolName, ToolDef> = {
  create_character: {
    ...
    actions: {
      ...
      set_expertise:      { description: "Rogue only: choose Expertise skills." },
      set_fighting_style: { description: "Fighter only: choose Fighting Style." },
      set_subclass:       { description: "Choose a subclass (if available at level 1)." },
      set_spells:         { description: "Choose starting cantrips and spells." },
